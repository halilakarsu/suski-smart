...
class ReportExport implements FromView, WithTitle, WithColumnWidths, WithEvents
{
    protected $data;
    protected $filters;
    protected $type;
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                for ($row = 3; $row <= $lastData; $row++) {
                    ...
                    if ($isYearly) {
                        $sheet->getStyle("D{$row}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER); // YIL
