...
@section('content')
<style>
    /* Ultra-Premium Glassmorphic Design for User Creation */
    ...
    .page-hero::before {
        ...
        top: -150px; right: -100px; border-radius: 50%; opacity: 0.6; filter: blur(40px);
...
<div class="pg-premium p-0">
    <div class="page-hero">
        <div class="hero-container">
            <h1 class="hero-title">Yeni Personel Kaydı</h1>
            <p class="hero-subtitle">Sisteme yeni bir kullanıcı ekleyerek yetki tanımlaması yapın.</p>
        </div>
    </div>
    ...
    <div class="form-container">
        <div class="glass-card">
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <h5 class="section-title"><i class="fas fa-user-circle"></i> Temel Profil Bilgileri</h5>
                
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-grp">
                            <label for="name">Ad Soyad <span>*</span></label>
                            <input type="text" id="name" name="name" class="form-control-pro" value="{{ old('name') }}" required autofocus placeholder="Örn: Ahmet Yılmaz">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-grp">
                            ...
                            <input type="email" id="email" name="email" class="form-control-pro" value="{{ old('email') }}" required placeholder="ahmet@kurum.com">
                    ...
                    <div class="col-md-6">
                        <div class="input-grp">
                            ...
                            <select name="role" id="role" class="select-pro" required>
                                <option value="personel" {{ old('role') == 'personel' ? 'selected' : '' }}>Personel (Kısmi Yetki)</option>
                                <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Yönetici (Tam Yetki)</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <h5 class="section-title"><i class="fas fa-shield-alt"></i> Güvenlik ve Şifre</h5>

                <div class="row">
                    <div class="col-md-6">
                        <div class="input-grp">
                            <label for="password">Giriş Şifresi <span>*</span></label>
                            <input type="password" id="password" name="password" class="form-control-pro" required placeholder="Min. 8 karakter">
                            @error('password') <span class="invalid-fb">{{ $message }}</span> @enderror
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-grp">
                            <label for="password_confirmation">Şifre Onayı <span>*</span></label>
                            <input type="password" id="password_confirmation" name="password_confirmation" class="form-control-pro" required placeholder="Şifreyi tekrarla">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-footer">
                    ...
                    <button type="submit" class="btn-pro btn-save">
                        <i class="fas fa-save"></i> Personeli Kaydet
                    </button>
                </div>
            </form>
        </div>
