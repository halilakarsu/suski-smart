...
<div class="page-hero">
    <div class="hero-container">
        <div class="hero-title-group">
            <h1>🪣 Yeni Kuyu Ekle</h1>
            <p class="hero-subtitle">Kuyu Envanteri / Yeni Kayıt</p>
        </div>
    </div>
</div>
...
<div class="main-container">
    <div class="glass-card">
        <form action="{{ route('kuyu-envanteri.store') }}" method="POST">
            @csrf
            ...
            <div class="form-grid col3">
                <div class="form-group">
                    ...
                    <input type="text" name="kuyu_no" value="{{ old('kuyu_no') }}" placeholder="ör: 100">
                </div>
                <div class="form-group">
                    <label>Abone No / Tesisat No</label>
                    <input type="text" name="abone_no" value="{{ old('abone_no') }}" placeholder="Tesist no">
                </div>
                <div class="form-group">
                    <label>İlçe</label>
                    <input type="text" name="ilce" list="ilce-list" value="{{ old('ilce') }}" placeholder="İlçe adı">
            ...
            <div class="form-grid" style="margin-top:16px">
                <div class="form-group" style="grid-column:1/-1">
                    <label>Adres</label>
                    <input type="text" name="adres" value="{{ old('adres') }}" placeholder="Mahalle / köy / bölge">
                </div>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="number" step="0.000001" name="cbs_x" value="{{ old('cbs_x') }}" placeholder="ör: 28.123456">
                </div>
                <div class="form-group">
                    <label>CBS Y Koordinatı</label>
                    <input type="number" step="0.000001" name="cbs_y" value="{{ old('cbs_y') }}" placeholder="ör: 41.123456">
                </div>
            </div>
            ...
            <div class="form-grid col3">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="demontaj_derinligi" value="{{ old('demontaj_derinligi') }}" placeholder="0.00">
                </div>
                <div class="form-group">
                    <label>Montaj Derinliği (m)</label>
                    <input type="number" step="0.01" name="montaj_derinligi" value="{{ old('montaj_derinligi') }}" placeholder="0.00">
                </div>
                <div class="form-group">
                    <label>Debi</label>
                    <input type="text" name="debi" value="{{ old('debi') }}" placeholder="ör: 25 L/dk">
                </div>
            </div>
            ...
            <div class="form-grid col3" style="margin-top:16px">
                <div class="form-group">
                    ...
                    <input type="text" name="boru_tipi" value="{{ old('boru_tipi') }}" placeholder='ör: 2" KALIN'>
                </div>
                <div class="form-group">
                    <label>Kablo</label>
                    <input type="text" name="kablo" value="{{ old('kablo') }}" placeholder="ör: 3X25 TEK">
                </div>
                <div class="form-group">
                    <label>Depo Bilgisi</label>
                    <input type="text" name="depo_bilgisi" value="{{ old('depo_bilgisi') }}" placeholder="ör: ŞEBEKE / TANK">
                </div>
            </div>
            ...
            <div class="form-grid" style="margin-top:16px">
                <div class="form-group">
                    <label>Motor</label>
                    <input type="text" name="motor" value="{{ old('motor') }}" placeholder="ör: 6' - 15.0 HP - WATERMOT">
                </div>
                <div class="form-group">
                    <label>Pompa</label>
                    <input type="text" name="pompa" value="{{ old('pompa') }}" placeholder="ör: 603/24 - YILDIZSU">
                </div>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="olusturulma_tarihi" value="{{ old('olusturulma_tarihi') }}">
                </div>
                <div class="form-group">
                    <label>Güncellenme Tarihi</label>
                    <input type="datetime-local" name="guncellenme_tarihi" value="{{ old('guncellenme_tarihi') }}">
                </div>
            </div>
            ...
            <div class="form-group">
                <textarea name="aciklama" placeholder="Ek açıklama, notlar…">{{ old('aciklama') }}</textarea>
            </div>
