...
<style>
    ...
    .btn-danger-pro { background: linear-gradient(135deg, #dc2626, #b91c1c); color: white !important; }
...
<div class="pg-premium p-0">
    <div class="page-hero">
        <div class="hero-container">
            <div class="hero-title-group">
                <h1 class="hero-title">Tesis Düzenle</h1>
                <p class="hero-subtitle">{{ $tesis->ilce }} / {{ $tesis->mahalle }} - Kuyu: {{ $tesis->kuyu_no ?? '—' }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="main-container">
        <div class="glass-card">
            <form action="{{ route('tesis-bilgi-sistemi.tesisler.update', $tesis->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <select name="durum" class="form-control-pro" required>
                            <option value="aktif" {{ old('durum', $tesis->durum) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                            <option value="pasif" {{ old('durum', $tesis->durum) == 'pasif' ? 'selected' : '' }}>Pasif</option>
                        </select>
                    </div>
                    <div class="col-md-4 mb-4">
                        ...
                        <select name="ilce" class="form-control-pro" required>
                            ...
                            <option value="{{ $i }}" {{ old('ilce', $tesis->ilce) == $i ? 'selected' : '' }}>{{ $i }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4 mb-4">
                        ...
                        <select name="abone_id" class="form-control-pro">
                            ...
                            <option value="{{ $a->id }}" {{ old('abone_id', $tesis->abone_id) == $a->id ? 'selected' : '' }}>{{ $a->ABONE_TESIS_NO }} - {{ $a->UNVAN }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" name="mahalle" class="form-control-pro" value="{{ old('mahalle', $tesis->mahalle) }}" required>
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label">Sokak</label>
                        <input type="text" name="sokak" class="form-control-pro" value="{{ old('sokak', $tesis->sokak) }}">
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label">Kuyu No</label>
                        <input type="text" name="kuyu_no" class="form-control-pro" value="{{ old('kuyu_no', $tesis->kuyu_no) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" name="cbs_x" class="form-control-pro" value="{{ old('cbs_x', $tesis->cbs_x) }}">
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label">CBS Y</label>
                        <input type="text" name="cbs_y" class="form-control-pro" value="{{ old('cbs_y', $tesis->cbs_y) }}">
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label">Abone No</label>
                        <input type="text" name="abone_no" class="form-control-pro" value="{{ old('abone_no', $tesis->abone_no) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" name="sayac_no" class="form-control-pro" value="{{ old('sayac_no', $tesis->sayac_no) }}">
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label">Tesis Kurulma Tarihi</label>
                        <input type="date" name="tesis_kurulma_tarihi" class="form-control-pro" value="{{ old('tesis_kurulma_tarihi', $tesis->tesis_kurulma_tarihi ? $tesis->tesis_kurulma_tarihi->format('Y-m-d') : '') }}">
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label">Abone Tipi</label>
                        <input type="text" name="abone_tipi" class="form-control-pro" value="{{ old('abone_tipi', $tesis->abone_tipi) }}" placeholder="AG / OG">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" name="trafo_gucu" class="form-control-pro" value="{{ old('trafo_gucu', $tesis->trafo_gucu) }}">
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label">Trafo Seri No</label>
                        <input type="text" name="trafo_seri_no" class="form-control-pro" value="{{ old('trafo_seri_no', $tesis->trafo_seri_no) }}">
                    </div>
                    <div class="col-md-4 mb-4">
                        <label class="form-label">ENH Durumu</label>
                        <input type="text" name="enh_durumu" class="form-control-pro" value="{{ old('enh_durumu', $tesis->enh_durumu) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="date" name="demontaj_tarihi" class="form-control-pro" value="{{ old('demontaj_tarihi', $tesis->demontaj_tarihi ? $tesis->demontaj_tarihi->format('Y-m-d') : '') }}">
                    </div>
                    <div class="col-md-8 mb-4">
                        <label class="form-label">Demontaj Yapılan Malzemeler</label>
                        <textarea name="demontaj_yapilan_malzemeler" class="form-control-pro" rows="2">{{ old('demontaj_yapilan_malzemeler', $tesis->demontaj_yapilan_malzemeler) }}</textarea>
                    </div>
                </div>
