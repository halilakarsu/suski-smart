...
return new class extends Migration {
    ...
    {
        // fatura_itirazlar
        Schema::create('fatura_itirazlar', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('itiraz_nedeni')->nullable();
            $table->foreignId('itiraz_eden_id')->nullable()->constrained('users')->nullOnDelete();
            $table->timestamp('itiraz_tarihi')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('fatura_itirazlar');
    }
};