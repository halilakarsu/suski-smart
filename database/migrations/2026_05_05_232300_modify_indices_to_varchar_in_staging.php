...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('bekleme_kontrol_havuzu', function (Blueprint $table) {
            ...
            foreach ($cols as $col) {
                DB::statement("ALTER TABLE `bekleme_kontrol_havuzu` MODIFY `$col` VARCHAR(255) NULL");
            }
        });
    }
    ...
    {
        // Geri dönüşte tekrar decimal'e çekmek riskli olabilir ama prensip gereği yazalım
        Schema::table('bekleme_kontrol_havuzu', function (Blueprint $table) {
            $cols = [
                't1_ilk_endeks', 't2_ilk_endeks', 't3_ilk_endeks', 't0_ilk_endeks',
                't1_son_endeks', 't2_son_endeks', 't3_son_endeks', 'to_son_endeks',
            ...
            foreach ($cols as $col) {
                DB::statement("ALTER TABLE `bekleme_kontrol_havuzu` MODIFY `$col` DECIMAL(12, 2) NULL");
            }
        });
    }
};
